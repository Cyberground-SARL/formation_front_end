  ...
  return (
    <>
      ...
      <Col
        ...
        xs={12}
        xxs={12}
        className={StyleCreate.container}
      >
        <Form className={StyleCreate.form}>
          <Form.Group className={StyleCreate.formGroup}>
            <Form.Label className={StyleCreate.formLabel}>
              Task title :{" "}
            </Form.Label>
            <Form.Control
              className={StyleCreate.formControl}
              type="text"
          ...
          <Form.Group className={StyleCreate.formGroup}>
            <Button type="submit" className={StyleCreate.submitBtn}>
              Create
            </Button>
          </Form.Group>
        </Form>
